...
input(2).name   = fullfile(work_dir,'derivatives','SEPIA','GE','Monopolar','GRE','sub-001_ses-GE_acq-Monopolar_part-mag_GRE.nii.gz');
...
output_basename = fullfile(work_dir,'derivatives','SEPIA','GE','Monopolar','GRE','Pipeline_Alternative1','sub-001_ses-GE_acq-Monopolar');
