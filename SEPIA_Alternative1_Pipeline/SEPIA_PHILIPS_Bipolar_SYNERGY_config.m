...
input = struct();
input(1).name   = fullfile(work_dir,'derivatives','SEPIA','PHILIPS','Bipolar_SYNERGY','GRE','Pipeline_Standard','sub-001_ses-PHILIPS_acq-BipolarSYNERGY_localfield.nii.gz');
input(2).name   = fullfile(work_dir,'derivatives','SEPIA','PHILIPS','Bipolar_SYNERGY','GRE','sub-001_ses-PHILIPS_acq-BipolarSYNERGY_part-mag_GRE.nii.gz');
input(3).name   = fullfile(work_dir,'derivatives','SEPIA','PHILIPS','Bipolar_SYNERGY','GRE','Pipeline_Standard','sub-001_ses-PHILIPS_acq-BipolarSYNERGY_weights.nii.gz'); 
input(4).name   = fullfile(work_dir,'derivatives','SEPIA','PHILIPS','Bipolar_SYNERGY','GRE','sepia_header.mat');
output_basename = fullfile(work_dir,'derivatives','SEPIA','PHILIPS','Bipolar_SYNERGY','GRE','Pipeline_Alternative1','sub-001_ses-PHILIPS_acq-BipolarSYNERGY');
mask_filename   = fullfile(work_dir,'derivatives','SEPIA','PHILIPS','Bipolar_SYNERGY','GRE','Pipeline_Standard','sub-001_ses-PHILIPS_acq-BipolarSYNERGY_mask_QSM.nii.gz');
