...
% 
% Data required: 
%   (1) SEPIA-ready multi-echo GRE data from SIEMENS, Monopolar readout
...
input = struct();
input(1).name   = fullfile(work_dir,'derivatives','SEPIA','SIEMENS','Monopolar','GRE','Pipeline_Standard','sub-001_ses-SIEMENS_acq-Monopolar_localfield.nii.gz');
input(2).name   = fullfile(work_dir,'derivatives','SEPIA','SIEMENS','Monopolar','GRE','sub-001_ses-SIEMENS_acq-Monopolar_part-mag_GRE.nii.gz');
input(3).name   = fullfile(work_dir,'derivatives','SEPIA','SIEMENS','Monopolar','GRE','Pipeline_Standard','sub-001_ses-SIEMENS_acq-Monopolar_weights.nii.gz'); 
input(4).name   = fullfile(work_dir,'derivatives','SEPIA','SIEMENS','Monopolar','GRE','sepia_header.mat');
output_basename = fullfile(work_dir,'derivatives','SEPIA','SIEMENS','Monopolar','GRE','Pipeline_Alternative1','sub-001_ses-SIEMENS_acq-Monopolar');
mask_filename   = fullfile(work_dir,'derivatives','SEPIA','SIEMENS','Monopolar','GRE','Pipeline_Standard','sub-001_ses-SIEMENS_acq-Monopolar_mask_QSM.nii.gz');
