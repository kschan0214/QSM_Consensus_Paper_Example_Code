...
% input = '/project/3015069.01/pilot/qsmhubTestdata/QSM_consensus_paper/derivatives/SEPIA/PHILIPS/Bipolar_SYNERGY/GRE' ;
% output_basename = '/project/3015069.01/pilot/qsmhubTestdata/QSM_consensus_paper/derivatives/SEPIA/PHILIPS/Bipolar_SYNERGY/GRE/Pipeline_romeo_lbv_itik/sub-001_ses-PHILIPS_acq-BipolarSYNERGY' ;
input           = fullfile(work_dir,'derivatives','SEPIA','PHILIPS','Bipolar_SYNERGY','GRE');
output_basename = fullfile(input,'Pipeline_romeo_lbv_itik','sub-001_ses-PHILIPS_acq-BipolarSYNERGY');
mask_filename = [''] ;
