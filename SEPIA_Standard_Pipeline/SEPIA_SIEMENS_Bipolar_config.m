...
% 
% Data required: 
%   SEPIA-ready multi-echo GRE data from SIEMENS, Bipolar readout
%
...
input           = fullfile(work_dir,'derivatives','SEPIA','SIEMENS','Bipolar','GRE');
output_basename = fullfile(input,'Pipeline_Standard','sub-001_ses-SIEMENS_acq-Bipolar');
mask_filename   = [''] ;
