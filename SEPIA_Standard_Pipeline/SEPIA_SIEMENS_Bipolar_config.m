...
% input = '/project/3015069.01/pilot/qsmhubTestdata/QSM_consensus_paper/derivatives/SEPIA/SIEMENS/Bipolar/GRE' ;
% output_basename = '/project/3015069.01/pilot/qsmhubTestdata/QSM_consensus_paper/derivatives/SEPIA/SIEMENS/Bipolar/GRE/Pipeline_romeo_lbv_itik/sub-001_ses-SIEMENS_acq-Bipolar' ;
input           = fullfile(work_dir,'derivatives','SEPIA','SIEMENS','Bipolar','GRE');
output_basename = fullfile(input,'Pipeline_romeo_lbv_itik','sub-001_ses-SIEMENS_acq-Bipolar');
mask_filename = [''] ;
