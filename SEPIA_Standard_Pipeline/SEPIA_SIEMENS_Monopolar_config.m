...
% input = '/project/3015069.01/pilot/qsmhubTestdata/QSM_consensus_paper/derivatives/SEPIA/SIEMENS/Monopolar/GRE' ;
% output_basename = '/project/3015069.01/pilot/qsmhubTestdata/QSM_consensus_paper/derivatives/SEPIA/SIEMENS/Monopolar/GRE/Pipeline_romeo_lbv_itik/sub-001_ses-SIEMENS_acq-Monopolar' ;
input           = fullfile(work_dir,'derivatives','SEPIA','SIEMENS','Monopolar','GRE');
output_basename = fullfile(input,'Pipeline_romeo_lbv_itik','sub-001_ses-SIEMENS_acq-Monopolar');
mask_filename = [''] ;
