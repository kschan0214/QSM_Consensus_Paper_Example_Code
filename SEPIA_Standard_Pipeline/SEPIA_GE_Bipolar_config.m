...
% 
% Data required: 
%   SEPIA-ready multi-echo GRE data from GE, Bipolar readout
%
...
% input = '/project/3015069.01/pilot/qsmhubTestdata/QSM_consensus_paper/derivatives/SEPIA/GE/Bipolar/GRE' ;
% output_basename = '/project/3015069.01/pilot/qsmhubTestdata/QSM_consensus_paper/derivatives/SEPIA/GE/Bipolar/GRE/Pipeline_romeo_lbv_itik/sub-001_ses-GE_acq-Bipolar' ;
input           = fullfile(work_dir,'derivatives','SEPIA','GE','Bipolar','GRE');
output_basename = fullfile(input,'Pipeline_romeo_lbv_itik','sub-001_ses-GE_acq-Bipolar');
