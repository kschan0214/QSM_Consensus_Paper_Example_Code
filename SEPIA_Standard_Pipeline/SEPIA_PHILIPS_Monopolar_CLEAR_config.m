...
% 
% Data required: 
%   SEPIA-ready multi-echo GRE data from PHILIPS, Monopolar readout, CLEAR normalisation
%
...
input           = fullfile(work_dir,'derivatives','SEPIA','PHILIPS','Monopolar_CLEAR','GRE');
output_basename = fullfile(input,'Pipeline_Standard','sub-001_ses-PHILIPS_acq-MonopolarCLEAR');
mask_filename   = [''] ;
