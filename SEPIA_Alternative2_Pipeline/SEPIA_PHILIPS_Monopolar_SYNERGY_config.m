...
output_basename = fullfile(work_dir,'derivatives','SEPIA','PHILIPS','Monopolar_SYNERGY','GRE','Pipeline_Alternative2','sub-001_ses-PHILIPS_acq-MonopolarSYNERGY');
...
algorParam.qsm.lambda = 0.0004 ;
algorParam.qsm.mu1 = 0.04 ;
